...
class Dialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		sbSizer7 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Output File Name" ), wx.VERTICAL )

		self.m_textCtrl1 = wx.TextCtrl( sbSizer7.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer7.Add( self.m_textCtrl1, 0, wx.ALL|wx.EXPAND, 5 )


		fgSizer1.Add( sbSizer7, 1, wx.EXPAND, 5 )

		sbSizer8 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Cutting Table Lengths (units to be added)" ), wx.VERTICAL )

		self.m_textCtrl3 = wx.TextCtrl( sbSizer8.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer8.Add( self.m_textCtrl3, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.m_textCtrl4 = wx.TextCtrl( sbSizer8.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer8.Add( self.m_textCtrl4, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		self.m_textCtrl5 = wx.TextCtrl( sbSizer8.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer8.Add( self.m_textCtrl5, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )


		fgSizer1.Add( sbSizer8, 1, wx.EXPAND, 5 )

		sbSizer81 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Cutter Move Time (minutes)" ), wx.VERTICAL )

		self.m_textCtrl51 = wx.TextCtrl( sbSizer81.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer81.Add( self.m_textCtrl51, 0, wx.ALL, 5 )


		fgSizer1.Add( sbSizer81, 1, wx.EXPAND, 5 )
